...
from app.routes import auth_routes, buddy_routes, insight_routes, listing_routes, user_routes
...
app.include_router(buddy_routes.router, prefix="/buddies", tags=["buddies"])
